...
__DEFINE__(1651842142804, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1651842142805,"./event-store":1651842142806}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1651842142805, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1651842142806, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1651842142805,"./utils":1651842142807}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1651842142807, function(require, module, exports) {
...
return __REQUIRE__(1651842142804);
})()
